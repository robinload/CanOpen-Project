...
private:
    ...
    // std::vector<BYTE> ProcessMessageCan(TPCANMsg msg, TPCANTimestamp itsTimeStamp);
    std::pair<UINT32, std::vector<BYTE>> ProcessMessageCan(TPCANMsg msg, TPCANTimestamp itsTimeStamp);
